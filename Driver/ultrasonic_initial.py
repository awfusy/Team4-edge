...
# MQTT Configuration
mqtt_broker = "192.168.211.254"  # Change this to your broker address
mqtt_port = 1883
...
while True:
    ...
    patient_on_bed = not (distance1 >= 10 and distance2 >= 10 and distance3 >= 10 and distance4>=10)  # or distance4 > 10)
    ...
    client.publish(mqtt_topic_distance, json.dumps(sensor_data))
