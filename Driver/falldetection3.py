...
SIO_SERVER = "http://localhost:5000"  # Change to your Socket.IO server address
    ...
    while True:
        if camera_active:
            ...
            try:
                ...
                # Encode frame to base64 JPEG and send via Socket.IO
                ...
                try:
                    ...
                    print(f"Failed to send frame via Socket.IO: {e}")
                    continue
